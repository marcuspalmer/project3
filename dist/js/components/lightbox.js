...
(function (global, factory) {
    ...
    (global = global || self, global.UIkitLightbox = factory(global.UIkit.util));
                ...
                handler: function(_, item) {
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i)) {
                        ...
                        uikitUtil.getImage(source).then(
                            function (img) { return this$1.setItem(item, ("<img width=\"" + (img.width) + "\" height=\"" + (img.height) + "\" src=\"../../../uikit/src/js/components/" + source + "\" alt=\"" + (alt ? alt : '') + "\">")); },
                        ...
                        this.setItem(item, ("<iframe class=\"uk-lightbox-iframe\" src=\"../../../uikit/src/js/components/" + source + "\" frameborder=\"0\" allowfullscreen></iframe>"));
    ...
    function getIframe(src, width, height, autoplay) {
        return ("<iframe src=\"../../../uikit/src/js/components/" + src + "\" width=\"" + width + "\" height=\"" + height + "\" style=\"max-width: 100%; box-sizing: border-box;\" frameborder=\"0\" allowfullscreen uk-video=\"autoplay: " + autoplay + "\" uk-responsive></iframe>");
    }
